...
const MESSAGES = {
  en: {
    ...
    menu: {
      ...
      disableBrowserTabReuse: 'Click to disable browser tab reuse',
  ...
  'zh-Hans': {
    ...
    menu: {
      ...
      notifyWaitingConfirmation: '等待确认',
      notifyWaitingReply: '等待回复',
      notifyAutoConfirmWaiting: '自动确认模式仍通知',
      browserTabs: '浏览器标签页',
      enableBrowserTabReuse: '点击开启浏览器标签页复用',
      disableBrowserTabReuse: '点击关闭浏览器标签页复用',
      openAutomationSettings: '打开系统自动化设置',
      browserTabReusePermission: '需要浏览器自动化权限',
      displayConfig: '显示配置',
      showStoppedAgents: '已停止 Agent',
      showDuration: '时长',
      showModel: '模型',
  ...
  'zh-Hant': {
    ...
    menu: {
      ...
      notifyWaitingConfirmation: '等待確認',
      notifyWaitingReply: '等待回覆',
      notifyAutoConfirmWaiting: '自動確認模式仍通知',
      browserTabs: '瀏覽器分頁',
      enableBrowserTabReuse: '點擊開啟瀏覽器分頁重用',
      disableBrowserTabReuse: '點擊關閉瀏覽器分頁重用',
      openAutomationSettings: '開啟系統自動化設定',
      browserTabReusePermission: '需要瀏覽器自動化權限',
      displayConfig: '顯示設定',
      showStoppedAgents: '已停止 Agent',
      showDuration: '時長',
      showModel: '模型',
