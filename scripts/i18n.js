...
const MESSAGES = {
  ...
  'zh-Hans': {
    ...
    menu: {
      ...
      enableAutoConfirmWaitingNotifications: '自动确认模式仍通知',
      disableAutoConfirmWaitingNotifications: '自动确认模式不通知',
      browserTabs: '浏览器标签页',
  ...
  'zh-Hant': {
    ...
    menu: {
      ...
      enableAutoConfirmWaitingNotifications: '自動確認模式仍通知',
      disableAutoConfirmWaitingNotifications: '自動確認模式不通知',
      browserTabs: '瀏覽器分頁',
